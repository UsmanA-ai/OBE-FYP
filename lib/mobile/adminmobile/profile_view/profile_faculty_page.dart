...
class _AdminProfileFMobilePageState extends State<AdminProfileFMobilePage> {
  ...
  Future<void> searchStudentData(String id) async {
    try {
      ...
      print('Searching for faculty with ID: $id');
      // Reset fetched data
      ...
      // Handle errors
      print('Error searching for faculty: $e');
      // Show error message
      showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
            title: const Text('Error'),
            content: const Text(
                'An error occurred while searching for faculty data. Please try again later.'),
            actions: [
              TextButton(
                onPressed: () {
                  Navigator.of(context).pop();
  ...
  Future<void> deleteStudentData(String id) async {
    try {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: const Text('faculty data deleted successfully!'),
            actions: [
              TextButton(
                onPressed: () {
                  Navigator.of(context).pop();
      ...
      // Handle errors
      print('Error deleting faculty data: $e');
      // Show error message
      showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
            title: const Text('Error'),
            content: const Text(
                'An error occurred while deleting faculty data. Please try again later.'),
            actions: [
              TextButton(
                onPressed: () {
                  Navigator.of(context).pop();
                        ...
                        child: TextButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => FacultyUpdatePage(
                                          fetchedId: fetchedId ?? '',
                                          ...
                                          fetchedpermanentaddress:
                                              fetchedPAddress ?? '',
                                          fetchedpermanentdistrict:
                                              fetchedPDistrict ?? '',
                                          fetchedpresentaddress:
                                              fetchedTAddress ?? '',
                                          fetchedpresentdistrict:
                                              fetchedTDistrict ?? '',
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          ...
                          height: 100,
                          child: CircleAvatar(
                            backgroundImage: fetchedImageUrl != null
