...
class AdminFEnrollMobilePage extends StatefulWidget {
  const AdminFEnrollMobilePage({super.key});

  @override
  State<AdminFEnrollMobilePage> createState() => _AdminFEnrollMobilePageState();
}

class _AdminFEnrollMobilePageState extends State<AdminFEnrollMobilePage> {
...
// Function to upload image to Firebase Storage
  Future<String?> _uploadImageToFirebase() async {
    ...
    try {
      final ref = FirebaseStorage.instance.ref().child('profile_images').child('image_${DateTime.now().millisecondsSinceEpoch}.jpg');
                  ...
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        ...
                        content: const Text('Registration successful.Verification email sent.'),
                        actions: [
                          TextButton(
                            onPressed: () {
                              // Close the dialog
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Faculty Registration",style: TextStyle(color: Colors.white),),
                    ...
                    Row(
                      children: [
                        const Padding(
                          ...
                          child: Text("Faculty ID:",style: TextStyle(color: Colors.blue,fontSize: 20),),
                        ),
                        Padding(
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: ElevatedButton(onPressed: ()=> signup(context),
                              style: ElevatedButton.styleFrom(
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                              onPressed: ()
                              {
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>const AdminProfileFMobilePage()));
                              },
                              style: ElevatedButton.styleFrom(
