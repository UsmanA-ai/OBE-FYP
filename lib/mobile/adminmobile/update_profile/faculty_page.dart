...
class FacultyUpdatePage extends StatefulWidget {
  ...
  @override
  State<FacultyUpdatePage> createState() => _FacultyUpdatePageState();
}

class _FacultyUpdatePageState extends State<FacultyUpdatePage> {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Faculty Update Profile",style: TextStyle(color: Colors.white),),
