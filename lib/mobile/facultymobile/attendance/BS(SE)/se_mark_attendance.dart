...
class SEMarkMobileAttendance extends StatefulWidget {
  final String courseName;
  final String facultyName;
  final String program;

  const SEMarkMobileAttendance({
    super.key,
  ...
  @override
  State<SEMarkMobileAttendance> createState() => _SEMarkMobileAttendanceState();
}

class _SEMarkMobileAttendanceState extends State<SEMarkMobileAttendance> {
  ...
  Future<void> _upload() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('seattendance').add({
