...
class FacultyMobileCSQuizFolder extends StatelessWidget {
  final String program;
  const FacultyMobileCSQuizFolder({super.key, required this.program});
  @override
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title:
              const Text("Quiz Folder", style: TextStyle(color: Colors.white)),
              ...
              onSelected: (String choice) {
                if (choice == 'Assessment') {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          CSMapMobileObeQuiz(courseName: course['Coursename']),
                    ),
                  );
                }
              },
