...
class _AdminProfileFPageState extends State<AdminProfileFPage>{
    ...
    try {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: const Text('Error'),
            content: const Text('An error occurred while searching for faculty data. Please try again later.'),
            actions: [
              TextButton(
                onPressed: () {
                  Navigator.of(context).pop();
                          ...
                          child: Container(
                            ...
                            child: Stack(
                              children: [
                                ...
                                Positioned(
                                  top: 0,
                                  child: AdminHeader(name:"Faculty Profile"),
                                ),
                                          ...
                                          children: [
                                            const Padding(
                                              ...
                                              child: SizedBox(
                                                ...
                                                // color: Colors.red,
                                                child: CircleAvatar(
                                                  backgroundImage://NetworkImage(fetchedImageUrl!),
                                                  AssetImage(
                                            ...
                                            Padding(
                                                ...
                                                child: Text("Faculty ID: ${fetchedId ??""}",style: const TextStyle(color: Colors.blue),)
                                            ),
                                            Padding(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: TextButton(onPressed: ()
                                          {
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(builder: (context) =>FacultyUpdateProfile(
                                                fetchedId: fetchedId?? '',
