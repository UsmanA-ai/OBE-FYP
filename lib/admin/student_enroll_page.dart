                          ...
                          child: Container(
                            ...
                            child: Stack(
                              children: [
                                ...
                                Positioned(
                                  top: 0,
                                  child: AdminHeader(name:"Student Registration"),
                                ),
                                //Academic Profile.....................
                                Positioned(
                                  top: 80,
                                               ...
                                               children: [
                                                 Expanded(child: Column(
                                                   children: [
                                                     ...
                                                     const Padding(
                                                       padding:EdgeInsets.only(top: 2,right: 200),
                                                     ...
                                                     Row(
                                                       children: [
                                                         const Padding(
                                                           padding:EdgeInsets.only(left:20),
                                                           child: Text("Semester:",style: TextStyle(color: Colors.blue,fontSize: 20),),
                                                         ),
                                                         Padding(
                                                     ...
                                                     Row(
                                                       children: [
                                                         const Padding(
                                                           padding:EdgeInsets.only(left:20),
                                                           child: Text("Section:",style: TextStyle(color: Colors.blue,fontSize: 20),),
                                                         ),
                                                         Padding(
                                                     ...
                                                     Row(
                                                       children: [
                                                         const Padding(
                                                           padding:EdgeInsets.only(left:20),
                                                           child: Text("Status:",style: TextStyle(color: Colors.blue,fontSize: 20),),
                                                         ),
                                                         Padding(
                                                             padding: const EdgeInsets.only(left:45),
                                                             child: DropdownButton<String>(
                                                     ...
                                                     Row(
                                                       children: [
                                                         const Padding(
                                                           padding:EdgeInsets.only(left:10),
                                                           child: Text("City:",style: TextStyle(color: Colors.black,fontSize: 20),),
                                                         ),
                                                         Padding(
                                                 ...
                                                 Expanded(child: Column(
                                                   children: [
                                                     const Padding(
                                                       padding:EdgeInsets.only(top: 15,right: 320),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          : ElevatedButton(onPressed: ()=> signup(context),
                                              style: ElevatedButton.styleFrom(
                                        ...
                                        Container(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: ()
                                              {
                                                Navigator.push(context, MaterialPageRoute(builder: (context)=>const AdminProfileSPage()));
                                              },
                                              style: ElevatedButton.styleFrom(
