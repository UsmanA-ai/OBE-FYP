...
class CSMapMidExam extends StatefulWidget {
  final String courseName;
  const CSMapMidExam({Key? key, required this.courseName}) : super(key: key);

  @override
  _CSMapMidExamState createState() => _CSMapMidExamState();
}

class _CSMapMidExamState extends State<CSMapMidExam> {
  ...
  Future<void> addQuiz() async {
    ...
    try {
      await FirebaseFirestore.instance.collection('cs_mid_exam').add(quizData);
                          ...
                          child: const Stack(
                            children: [
                              Positioned(
                                  top: 0,
                                  child:
                                      FacultyHeader(name: "CS Mid Exam Clos")),
                            ],
                          ),
                        ),
                      ),
