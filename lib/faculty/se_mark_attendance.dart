...
class SEMarkAttendance extends StatefulWidget {
  final String courseName;
  final String facultyName;
  final String program;

  const SEMarkAttendance({
    super.key,
  ...
  @override
  State<SEMarkAttendance> createState() => _SEMarkAttendanceState();
}

class _SEMarkAttendanceState extends State<SEMarkAttendance> {
