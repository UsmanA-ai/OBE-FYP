...
import 'cs_map_midexam.dart';
import 'cs_plos_page.dart';

class FacultyCSMidFolder extends StatelessWidget {
  final String program;
  const FacultyCSMidFolder({Key? key, required this.program}) : super(key: key);
  @override
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          children: [
                            const Positioned(
                              top: 0,
                              child: FacultyHeader(name: "CS Mid Exam Folder"),
                            ),
                            Positioned(
                              top: 100,
                              left: 50,
                ...
                onSelected: (String choice) {
                  if (choice == 'Assessment') {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            CSMapMidExam(courseName: course['Coursename']),
                      ),
                    );
                  }
                },
