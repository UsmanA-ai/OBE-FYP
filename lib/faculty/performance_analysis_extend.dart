...
import 'package:myapp/faculty/student_attendance_detail.dart';
import '../components.dart';

class FacultyPerformanceDashboardExtend extends StatelessWidget {
  const FacultyPerformanceDashboardExtend({super.key});
