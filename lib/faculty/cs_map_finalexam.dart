...
class _CSMapFinalExamState extends State<CSMapFinalExam> {
  ...
  Future<void> addQuiz() async {
    if (finaltextcontroller.text.isEmpty ||
    ...
    final quizData = {
      ...
      'finalexam': finaltextcontroller.text,
        ...
        content: SingleChildScrollView(
          child: ListBody(
            children: [
              ...
              Text('Final_Exam: ${quiz['finalexam']}'),
              Text('Type: ${quiz['type']}'),
                      ...
                      child: DataTable(
                        ...
                        rows: midList.map((quiz) {
                          return DataRow(cells: [
                            ...
                            DataCell(Text(quiz['finalexam'] ?? '')),
                            DataCell(Text(quiz['type'] ?? '')),
