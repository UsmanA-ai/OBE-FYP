...
import 'package:myapp/faculty/se_map_finalexam.dart';
import 'package:myapp/faculty/se_plos_page.dart';
import '../components.dart';

class FacultySEFinalFolder extends StatelessWidget {
  final String program;
  const FacultySEFinalFolder({super.key, required this.program});
  @override
                        ...
                        child: Stack(
                          children: [
                            const Positioned(
                              top: 0,
                              child:
                                  FacultyHeader(name: "SE Fianl Exam Folder"),
                            ),
                            Positioned(
                              top: 100,
                              left: 50,
                ...
                onSelected: (String choice) {
                  if (choice == 'Assessment') {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            SEMapFinalExam(courseName: course['Coursename']),
                      ),
                    );
                  }
                },
