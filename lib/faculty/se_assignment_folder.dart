...
import 'package:myapp/faculty/se_map_assignment.dart';
import 'package:myapp/faculty/se_plos_page.dart';
import '../components.dart';

class FacultySEAssignmentFolder extends StatelessWidget {
  final String program;
  const FacultySEAssignmentFolder({super.key, required this.program});
                        ...
                        child: Stack(
                          children: [
                            const Positioned(
                              top: 0,
                              child:
                                  FacultyHeader(name: "SE Assignment Folder"),
                            ),
                            Positioned(
                              top: 100,
                              left: 50,
                ...
                onSelected: (String choice) {
                  if (choice == 'Assessment') {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => SEMapObeAssignment(
