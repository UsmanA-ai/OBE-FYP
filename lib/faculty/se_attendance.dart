...
import 'package:myapp/faculty/se_mark_attendance.dart';
import 'package:myapp/faculty/se_plos_page.dart';
import '../components.dart';

class FacultySEAttendanceFolder extends StatelessWidget {
  final String program;
  const FacultySEAttendanceFolder({super.key, required this.program});
                ...
                onSelected: (String choice) {
                  if (choice == 'Mark') {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => SEMarkAttendance(
