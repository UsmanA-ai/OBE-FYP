...
import 'package:myapp/faculty/se_map_quiz.dart';
import 'package:myapp/faculty/se_plos_page.dart';
import '../components.dart';

class FacultySEQuizFolder extends StatelessWidget {
  final String program;
  const FacultySEQuizFolder({super.key, required this.program});
  @override
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          children: [
                            const Positioned(
                              top: 0,
                              child: FacultyHeader(name: "SE Quiz Folder"),
                            ),
                            Positioned(
                              top: 100,
                              left: 50,
                ...
                onSelected: (String choice) {
                  if (choice == 'Assessment') {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            SEMapObeQuiz(courseName: course['Coursename']),
                      ),
                    );
                  }
                },
