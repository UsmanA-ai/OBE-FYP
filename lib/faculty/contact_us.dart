...
class _FacultyContactusState extends State<FacultyContactus>{
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  crossAxisAlignment: CrossAxisAlignment.center,
                                                  children: [
                                                    Text("ID :",style: TextStyle(color: Colors.blueAccent[100],fontSize: 23),
                                                    ),
                                                    //SizedBox(width:70,),
                                                    Padding(
                                                ...
                                                Row(
                                                  ...
                                                  crossAxisAlignment: CrossAxisAlignment.center,
                                                  children: [
                                                    Text("Name :",style: TextStyle(color: Colors.blueAccent[100],fontSize: 23),
                                                    ),
                                                    //SizedBox(width:70,),
                                                    Padding(
                                                ...
                                                Row(
                                                  ...
                                                  crossAxisAlignment: CrossAxisAlignment.center,
                                                  children: [
                                                    Text("Email :",style: TextStyle(color: Colors.blueAccent[100],fontSize: 23),
                                                    ),
                                                    //SizedBox(width:70,),
                                                    Padding(
                                                ...
                                                Row(
                                                  ...
                                                  crossAxisAlignment: CrossAxisAlignment.center,
                                                  children: [
                                                    Text("Message :",style: TextStyle(color: Colors.blueAccent[100],fontSize: 23),
                                                    ),
