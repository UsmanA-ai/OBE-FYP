...
import 'package:myapp/faculty/cs_map_assignment.dart';
import '../components.dart';
import 'cs_plos_page.dart';

class FacultyCSAssignmentFolder extends StatelessWidget {
  final String program;
  const FacultyCSAssignmentFolder({super.key, required this.program});
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          children: [
                            const Positioned(
                              top: 0,
                              child: FacultyHeader(name: "CS Course Folder"),
                            ),
                            Positioned(
                              top: 100,
                              left: 50,
        ...
        columns: [
          DataColumn(
              label: Text('Course Name',
                  style:
                      TextStyle(color: Colors.blueAccent[100], fontSize: 23))),
          DataColumn(
                ...
                onSelected: (String choice) {
                  if (choice == 'Assessment') {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => CSMapObeAssignment(
